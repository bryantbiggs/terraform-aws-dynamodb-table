...
| <a name="input_autoscaling_policy_name_modifier"></a> [autoscaling\_policy\_name\_modifier](#input\_autoscaling\_policy\_name\_modifier) | Modifier that is prefixed before the autoscaling target resource ID. When importing resources created outside of this module, you may need to set this to `table/` | `string` | `""` | no |
